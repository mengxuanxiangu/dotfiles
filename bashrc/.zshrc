...
alias h='htop'
alias vi=vim
alias optmp='source /home/op/opbin/optool/bin/optmp'
alias format='python -m json.tool'
alias ck=comake2 
...
baas bind --baas_user=houjinchao --local_account=work --baas_role=baas_all_privilege --baas_group=baas_default_group --enable_rsa_token 2 &>/dev/null
...
export PATH
PATH=/home/work/pre-submit/usr/bin:$PATH
export PATH
