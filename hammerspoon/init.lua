...
local m_ctrl_shift = {"ctrl", "shift"}

local m_switch_app = m_ctrl_shift
...
local APP_LAYOUT = {
    [1] = {
        ...
        two_monitor = {
            ...
            [APPNAMES.Browser] = {2, LAYOUTS.fullscreen},
            [APPNAMES.Mail] = {1, LAYOUTS.fullscreen},
            [APPNAMES.IM] = {1, LAYOUTS.right},
            [APPNAMES.HI] = {1, LAYOUTS.right},
            [APPNAMES.Doc] = {1, LAYOUTS.right},
            [APPNAMES.FileManager] = {1, LAYOUTS.right},
            [APPNAMES.WeChat] = {1, LAYOUTS.right},
            [APPNAMES.Music] = {1, LAYOUTS.right},
...
--  常用的窗口布局
hs.fnutils.each({
    {key = "w", layout = LAYOUTS.fullscreen},
...
---
--  移动到屏幕
hs.hotkey.bind(m_ctrl_shift, "s", hs.grid.pushWindowPrevScreen)
